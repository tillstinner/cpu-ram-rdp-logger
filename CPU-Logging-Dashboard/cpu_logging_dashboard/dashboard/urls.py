...
from . import views
from .views import MetricCreateView, MetricLatestView, MetricHistoryView, MetricRangeView, HostListView, dashboard_view
...
urlpatterns = [
    ...
    path('api/metrics/hosts/', HostListView.as_view(), name='host-list'),  # 👈 new endpoint
